...
const DOCS: readonly ErrorTypeDoc[] = [
  ...
  },
  {
    ...
    meaning: 'The active organization on the session no longer exists.',
    resolution: 'Switch to another organization, then replay the request.',
  },
  {
    code: ERROR_CODES.ORGANIZATION_ROLE_NOT_FOUND,
    status: 404,
    title: 'Role not found',
    meaning: 'No tenant-defined role with that name exists in the active organization.',
    resolution: 'List roles first; system roles are not editable through this endpoint.',
  },
  {
    code: ERROR_CODES.ORGANIZATION_ROLE_ALREADY_EXISTS,
    status: 409,
    title: 'Role already exists',
    meaning: 'A role with this name is already defined in the organization.',
    resolution: 'Pick a different name, or update the existing role instead.',
  },
  {
    code: ERROR_CODES.ORGANIZATION_ROLE_IN_USE,
    status: 409,
    title: 'Role still in use',
    meaning:
      'The role is still assigned to at least one member, so deleting it would strip their permissions silently.',
    resolution: 'Reassign every member holding the role, then delete it.',
  },
  {
    code: ERROR_CODES.TEAM_NOT_FOUND,
    status: 404,
    title: 'Team not found',
    meaning: 'No team with that id exists in the active organization.',
    resolution: 'Check the identifier against the team list.',
  },
  {
    code: ERROR_CODES.TEAM_NAME_TAKEN,
    status: 409,
    title: 'Team name taken',
    meaning: 'A team with this name already exists in the organization.',
    resolution: 'Pick a different name.',
  },
  {
    code: ERROR_CODES.INVITATION_NOT_FOUND,
    status: 404,
    title: 'Invitation not found',
    meaning: 'No invitation with that id exists in the active organization.',
    resolution: 'Check the identifier against the invitation list.',
  },
  {
    ...
    meaning:
      'The invitation was already accepted, rejected or canceled, so it cannot be canceled again.',
    resolution: 'Send a new invitation instead of canceling a settled one.',
  },
  {
    code: ERROR_CODES.API_KEY_NOT_FOUND,
    status: 404,
    title: 'API key not found',
    meaning: 'No API key with that id exists in the active organization.',
    resolution: 'Check the identifier against the API key list.',
  },
  {
    ...
    meaning:
      'The presented API key does not match a live key — it is unknown, revoked, or expired.',
    resolution: 'Issue a new key. The raw value is only shown once, at creation.',
  },
  {
    code: ERROR_CODES.API_KEY_SCOPE_EXCEEDS_GRANT,
    status: 422,
    title: 'API key scope exceeds grant',
    meaning:
      'The requested scopes include a permission the caller does not hold, which would let a key escalate its creator.',
    resolution: 'Request only scopes within your own permissions.',
  },
  {
    code: ERROR_CODES.NOTIFICATION_NOT_FOUND,
    status: 404,
    title: 'Notification not found',
    meaning: 'No notification with that id is addressed to the caller.',
    resolution: 'Check the identifier against the notification list.',
  },
  {
    code: ERROR_CODES.FEATURE_FLAG_NOT_FOUND,
    status: 404,
    title: 'Feature flag not found',
    meaning: 'No feature flag with that id exists in the active organization.',
    resolution: 'Check the identifier against the feature flag list.',
  },
  {
    code: ERROR_CODES.FEATURE_FLAG_KEY_TAKEN,
    status: 409,
    title: 'Feature flag key taken',
    meaning: 'A feature flag with this key already exists in the organization.',
    resolution: 'Pick a different key, or update the existing flag.',
  },
  {
    code: ERROR_CODES.TERM_NOT_FOUND,
    status: 404,
    title: 'Term not found',
    meaning: 'No term document with that id or type exists.',
    resolution: 'Check the identifier, or list the published terms first.',
  },
  {
    code: ERROR_CODES.TERM_NOT_PUBLISHED,
    status: 409,
    title: 'Term not published',
    meaning: 'The term version exists but has no publication date, so it cannot be accepted yet.',
    resolution: 'Accept the currently published version instead.',
  },
  {
    code: ERROR_CODES.TERM_VERSION_TAKEN,
    status: 409,
    title: 'Term version taken',
    meaning: 'This version string already exists for this term type.',
    resolution: 'Publish a new version string.',
  },
  {
    code: ERROR_CODES.SESSION_NOT_FOUND,
    status: 404,
    title: 'Session not found',
    meaning: 'No session with that id belongs to the caller.',
    resolution: 'Refresh the session list; it may already have been revoked or expired.',
  },
];
