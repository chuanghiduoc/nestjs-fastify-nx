 ...
 */
import type { AdminUsersList200, AdminUsersListParams } from './api.schemas';
...
export type AdminUsersListResult = NonNullable<
  Awaited<ReturnType<ReturnType<typeof getAdmin>['adminUsersList']>>
>;
