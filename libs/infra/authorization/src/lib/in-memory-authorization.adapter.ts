import { SYSTEM_ROLE_PERMISSIONS, isSystemRole, type Permission } from '@nestjs-fastify-nx/shared';
 ...
 */
export class InMemoryAuthorizationAdapter extends BaseAuthorizationAdapter {
