...
- bearer-token ws auth, env-driven service identity, and nx release setup ([#117](https://github.com/chuanghiduoc/nestjs-fastify-nx/pull/117))
...
- tighten production csp and redact pii in sentry events ([#114](https://github.com/chuanghiduoc/nestjs-fastify-nx/pull/114))
- remediate production audit findings across security, db, perf, upload and infra ([#115](https://github.com/chuanghiduoc/nestjs-fastify-nx/pull/115))
- correct audit-followup doc/config accuracy gaps ([#116](https://github.com/chuanghiduoc/nestjs-fastify-nx/pull/116))
